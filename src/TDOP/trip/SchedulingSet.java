 ...
 *   1. A list of simulations. this si one trip now but later will be more troips
...
public class SchedulingSet {
    ...
    private List<Simulation> simulations;//one at the moment
    private List<Integer> replications;//even w same config... different random seed (job shop) not in trip
...
/*
   ...
   /* public static SchedulingSet generateSet(long simSeed,
                                            ...
                                            List<POI> pois,
                                            int replications) {
        System.out.println("guess this bit is important scheduling set");
    	if (scenario.equals("trip")) {
    		//return null;
            ...
            //return SchedulingSet.dynamicFullSet(simSeed, utilLevel, dueDateFactor, objectives, replications);//(simSeed, scenario, setName, objectives, replications);
