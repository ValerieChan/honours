...
public class GPNodeComparator {
    ...
    public static void main(String[] args) { 
        ...
        node1.children[0] = new AttributeGPNode(PlaceOfInterestAttribute.REMAINING_TIME);//DUE_DATE);
        node1.children[1] = new AttributeGPNode(PlaceOfInterestAttribute.NODE_SCORE);//PROC_TIME);

        GPNode node2 = new Div();
        node2.children = new GPNode[2];
        node2.children[0] = new AttributeGPNode(PlaceOfInterestAttribute.NODE_SCORE);//PROC_TIME);
        node2.children[1] = new AttributeGPNode(PlaceOfInterestAttribute.REMAINING_TIME);//DUE_DATE);
