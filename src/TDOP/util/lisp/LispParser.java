...
import TDOP.gp.terminal.ConstantTerminal;
import TDOP.gp.terminal.PlaceOfInterestAttribute;
import TDOP.ruleAnalysis.ResultFileReader;
import TDOP.ruleAnalysis.RuleType;
    ...
    private static GPNode parseNode(String expression) {
        ...
        if (expression.charAt(0) == '(') {
            ...
            if (NumberUtils.isNumber(expression)) {
                ...
                node = new AttributeGPNode(PlaceOfInterestAttribute.get(expression));
            }
